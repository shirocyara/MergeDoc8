...
public class FileChooserField extends JPanel {
	 ...
	 * <p>
	 * 
	 * プラットフォームでサポートされない文字セット名が追加された場合は無視します。 その判定は String のコンストラクタ
	 * {@link String(byte[],String)} を使用します。{@link Charset#isSupported} は
	 * JISAutoDetect の判定が 出来ないことや、JDK1.4.1 では ISO-2022-JP の場合 false を返すため
	 * 使用されません。
	 * <p>
	 * 
