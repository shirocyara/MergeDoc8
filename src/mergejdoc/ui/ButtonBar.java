...
public class ButtonBar extends JPanel {
  ...
  /** ロガー */
  private static final Logger logger = LogManager.getLogger(ButtonBar.class);
  ...
  /**
   * ボタン状態をセットします。 このメソッドを呼び出す前に適切なリスナーがセットされている必要があります。<br>
   * このメソッドはスレッドに対して安全です。
   * 
   * @param state ボタン状態
   */
  public void setState(final ButtonState state) {
    ...
    if (runListener == null || backListener == null || cancelListener == null
        || endListener == null) {
