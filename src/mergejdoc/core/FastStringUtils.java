...
public class FastStringUtils {
   ...
   * 
   * <p>
   * これは以下のような JDK の String#replace(CharSequence,CharSequence) メソッドと処理内容は同等ですが、内部的に使用する Pattern
   * オブジェクトを キャッシュするため、同じ target の場合、2 回目以降は高速です。
   * 
   * <pre>
   ...
   * 
   * <p>
   * これは以下のような JDK の String#replaceFirst(String,String) メソッドと処理内容は同等ですが、内部的に使用する Pattern オブジェクトを
   ...
   * 
   * <p>
   * これは以下のような JDK の String#replaceAll(String,String) メソッドと処理内容は同等ですが、内部的に使用する Pattern オブジェクトを
   * キャッシュするため、同じ regex の場合、2 回目以降は高速です。
   * 
   * <pre>
   ...
   * 
   * <p>
   * これは以下のような JDK の String#matches(String) メソッドと処理内容は同等ですが、内部的に使用する Pattern オブジェクトを キャッシュするため、同じ
   * regex の場合、2 回目以降は高速です。
   * 
   * <pre>
   * input.matches(regex);
   * </pre>
   ...
   * 
   * <p>
   * これは以下のような JDK の String#split(String,int) メソッドと処理内容は同等ですが、内部的に使用する Pattern オブジェクトを キャッシュするため、同じ
   * regex の場合、2 回目以降は高速です。
   * 
   * <pre>
